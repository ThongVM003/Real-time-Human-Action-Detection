...
def bbox_iou(box1, box2, x1y1x2y2=True):
    ...
    Parameters:
    - box1: list, the coordinates of the first bounding box in the format [x1, y1, x2, y2]
    - box2: list, the coordinates of the second bounding box in the format [x1, y1, x2, y2]
    - x1y1x2y2: bool, optional flag to indicate whether the coordinates are in the format [x1, y1, x2, y2] (default True)
